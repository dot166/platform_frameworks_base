 ...
 */
public class SettingsSpinnerPreference2 extends Preference
     ...
     */
    public SettingsSpinnerPreference2(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        setLayoutResource(R.layout.settings_spinner_preference_2);
        mOffset = context.getResources().getDimensionPixelSize(R.dimen.settingslib_spinner_dropdown_vertical_offset_normal);
     ...
     * @param attrs The attributes of the XML tag that is inflating the preference
     */
    public SettingsSpinnerPreference2(@NonNull Context context, @Nullable AttributeSet attrs) {
     ...
     */
    public SettingsSpinnerPreference2(@NonNull Context context) {
        this(context, null);
    }
