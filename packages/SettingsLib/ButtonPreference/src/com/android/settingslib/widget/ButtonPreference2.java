 ...
 */
public class ButtonPreference2 extends Preference {
     ...
     *                     defaults.
     */
    public ButtonPreference2(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * @param attrs   The attributes of the XML tag that is inflating the view.
     */
    public ButtonPreference2(Context context, AttributeSet attrs) {
     ...
     *                access the current theme, resources, etc.
     */
    public ButtonPreference2(Context context) {
        this(context, null);
    }
