...
its major version will be the AOSP SDK version that its sources match with a 1 at the start (because maven is doing its job, example, Android 16 - 36 - 136), the minor version will match AOSPs minor version,
