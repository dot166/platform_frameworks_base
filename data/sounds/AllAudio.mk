...
# this is a combination of AudioPackage14.mk and https://github.com/LineageOS/android_vendor_lineage/blob/d8ad094a4a4e2e295ce5b369caa8d3f352026785/config/aosp_audio.mk (with some modifications)
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/legacy/alarms/Argon-old.ogg:$(TARGET_COPY_OUT_PRODUCT)/media/audio/alarms/Argon-old.ogg \
    $(LOCAL_PATH)/legacy/alarms/Carbon-old.ogg:$(TARGET_COPY_OUT_PRODUCT)/media/audio/alarms/Carbon-old.ogg \
    $(LOCAL_PATH)/legacy/alarms/Krypton-old.ogg:$(TARGET_COPY_OUT_PRODUCT)/media/audio/alarms/Krypton-old.ogg \
    $(LOCAL_PATH)/legacy/alarms/Neon-old.ogg:$(TARGET_COPY_OUT_PRODUCT)/media/audio/alarms/Neon-old.ogg \
    $(LOCAL_PATH)/legacy/alarms/Osmium-old.ogg:$(TARGET_COPY_OUT_PRODUCT)/media/audio/alarms/Osmium-old.ogg \
    $(LOCAL_PATH)/legacy/alarms/Oxygen-old.ogg:$(TARGET_COPY_OUT_PRODUCT)/media/audio/alarms/Oxygen-old.ogg \
    $(LOCAL_PATH)/legacy/alarms/Platinum-old.ogg:$(TARGET_COPY_OUT_PRODUCT)/media/audio/alarms/Platinum-old.ogg
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/legacy/ringtones/Atria-holo.ogg:$(TARGET_COPY_OUT_PRODUCT)/media/audio/ringtones/Atria-holo.ogg
